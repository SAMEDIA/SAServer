...
$myconnect=mysql_select_db($dbname, $db);
$livestream_id_list = array();
	...
	public function insertstreaminfo($livestream_time,$livestream_time_zone,$livestream_place,$livestream_source_name,
		...
		$sql = "INSERT INTO songabout_live_stream (livestream_time,livestream_time_zone,livestream_place,livestream_source_name,livestream_name,livestream_genre,livestream_artist_name,livestream_link,livestream_type) VALUES (".$livestream_time.",'".$livestream_time_zone."','".$livestream_place."','".$livestream_source_name."','".$livestream_name."','".$livestream_genre."','".$livestream_artist_name."','".$livestream_link."','".$livestream_type."')";
		$listrs = mysqli_query($db,$sql);
		if($rs->num_rows>0){
			echo "Y";
			//return 0;
