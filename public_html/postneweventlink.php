...
<html>
	...
	<body>
		...
		<div>
		  ...
		  <form class="form-horizontal" action="addNewEvent.php" method="post" name="submiteventform" enctype="multipart/form-data" id="addnewevent">
		    ...
		    <div class="control-group">
		          ...
		          <div class="controls">
		            ...
		            <input type="text" placeholder="Enter artist here" class="input-xlarge" name="artist" id="artist">
            ...
            <div class="control-group">
                ...
                <div class="controls input-append date form_datetime" data-date="2014-08-16T05:25:07Z" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">

                    <input size="16" type="text" name="show_time">
				...
				<input type="hidden" id="dtp_input1" name="start_time"/><br/>
		    ...
		    <div class="control-group">
		          ...
		          <div class="controls">
		            ...
		            <input type="text" placeholder="Add Link Here" class="input-xlarge" name="links" id="links">
		    ...
		    <div class="control-group">
		          ...
		          <div class="controls">
		            ...
		            <input type="text" placeholder="Enter Event Place" class="input-xlarge" name="place" id="place">
