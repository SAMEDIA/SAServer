							...
							if(count($allVerifiedArtist)) {								
								foreach ($allVerifiedArtist as $result) {
									$indexResultsHtml .= '<tr class="odd">';
										...
										$indexResultsHtml .= '<td class="center"><a href="/~songabou/dashboard/action.php?action=approve&verifiedArtistId=' . $result->verified_artist_id . '" onclick="return confirm(\'Are you sure you want to accept this users request.  The user will be able to edit artist information.\');"><img src="images/icons/approveIcon.gif" title="Approve Artist" width="16" height="16" border="0"/></a></td>';
										$indexResultsHtml .= '<td class="center"><a href="/~songabou/dashboard/action.php?action=deny&verifiedArtistId=' . $result->verified_artist_id . '" onclick="return confirm(\'Are you sure you want to deny this users request.\');"><img src="images/icons/dissapproveIcon.png"  title="Deny Artist"   width="16" height="16"  border="0"/></a></td>';
										$indexResultsHtml .= '<td class="center"><a href="/~songabou/dashboard/action.php?action=delete&verifiedArtistId=' . $result->verified_artist_id . '" onclick="return confirm(\'Are you sure you want to delete this users request\');"><img src="images/icons/iconDelete.png" title="Deny Artist" width="16" height="16"  border="0"/></a></td>';
